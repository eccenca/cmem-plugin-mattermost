...
class MattermostIntegrationPlugin(WorkflowPlugin):
    ...
    def send_message_with_bot_to_user(self):
        ...
        response = requests.post(f"{self.url}/api/v4/users/search", headers={
        ...
        response = requests.post(f"{self.url}/api/v4/posts",
